...
Win32DisplayDevice::TranslateKeyCode(WPARAM wParam) const
{
    switch (wParam)
    {
        ...
        case VK_MENU:                   return Input::Key::Menu;
        ...
        case VK_LSHIFT:                 return Input::Key::LeftShift;
        case VK_RSHIFT:                 return Input::Key::RightShift;
        case VK_LCONTROL:               return Input::Key::LeftControl;
        case VK_RCONTROL:               return Input::Key::RightControl;
        case VK_LMENU:                  return Input::Key::LeftMenu;
        case VK_RMENU:                  return Input::Key::RightMenu;
