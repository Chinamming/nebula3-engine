...
// Attributes
public:
	CSelectTreeCtrl   m_wndExplorer;

// Operations
public:
	CWnd* OnCreateView();

	void OnExpandModel(const Ptr<Models::Model>& model);
	void OnExpandModelNode(const Ptr<Models::ModelNode>& model,HTREEITEM& htiParent,const Util::String& parentPath);
